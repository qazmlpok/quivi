...
class OptionsDialog(wx.Dialog):
    ...
    def _init_viewing(self):
        ...
        self.detect_spread_chk = wx.CheckBox(self.viewing_pane, -1, _("Display two-page spreads at double width"))
        self.scroll_at_bottom_chk = wx.CheckBox(self.viewing_pane, -1, _("Scroll horizontally when scrolling past end of image"))
    ...
    def __set_properties(self):
        ...
        detect_spreads = (self.settings.get('Options', 'DetectSpreads') == '1')
        self.detect_spread_chk.SetValue(detect_spreads)
    ...
    def __do_layout_viewing(self):
        ...
        viewing_sizer.Add(self.detect_spread_chk, 0, wx.LEFT|wx.RIGHT|wx.TOP, 5)
    ...
    def on_ok(self, event): # wxGlade: OptionsDialog.<event_handler>
        ...
        opt.detect_spreads = self.detect_spread_chk.GetValue()
